...
def main():
  ...
  if os.path.isdir(submit_dir) and os.path.isdir(truth_dir):
      ...
      gold_file = os.path.join(truth_dir, "instance_val_common.json")
      coco = COCO(gold_file)
      cocoGt = coco
      ...
      gold_file = os.path.join(truth_dir, "instance_val_agnostic.json")
      coco = COCO(gold_file)
      cocoGt = coco
      img_ids = coco.getImgIds()
      print("Evaluating bbox!")
      ...
      gold_file = os.path.join(truth_dir, "instance_val_agnostic_corner.json")
      coco = COCO(gold_file)
      cocoGt = coco
      img_ids = coco.getImgIds()
      print("Evaluating bbox!")
